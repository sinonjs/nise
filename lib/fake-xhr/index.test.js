...
var sinonFakeServer = require("../fake-server");
...
function assertBlobMatches(actual, expected) {
    return Promise.all([
        actual.text(),
...
describe("FakeXMLHttpRequest", function () {
    ...
    describe(".setRequestHeader", function () {
        ...
        it("ignores unsafe headers by default", function () {
            var xhr = this.xhr;
            ...
            assert.equals(xhr.requestHeaders, {});
        });

        it("ignores unsafe headers with header name case ignored", function () {
            var xhr = this.xhr;
    ...
    describe(".send", function () {
        ...
        it("does not throw if FormData is unavailable when send runs", function () {
            this.xhr.open("POST", "/");

            var originalFormData = global.FormData;
        ...
        if (supportsFormData) {
            ...
            it("does not throw if FormData becomes unavailable after module load", function () {
                this.xhr.open("POST", "/");
                var xhr = this.xhr;
    ...
    describe(".response", function () {
        ...
        it("returns null for HTML document responses when DOMParser is unavailable", function () {
            ...
            var originalDOMParser = global.DOMParser;
            delete global.DOMParser;
            ...
            describe("with ArrayBuffer support", function () {
                ...
                it("returns ArrayBuffer when responseType='arraybuffer'", function () {
                    ...
                    assertArrayBufferMatches(
                        this.xhr.response,
                        new Uint8Array([
                            97, 32, 116, 101, 115, 116, 32, 98, 117, 102, 102,
                            101, 114,
                        ]).buffer,
                    );
                });
                ...
                it("does not require an external text-encoding polyfill for string bodies", function () {
                    ...
                    var localSinonFakeXhr;
                    var xhr;

                    delete global.TextEncoder;

                    try {
                        localSinonFakeXhr = proxyquire("./index", {
                            "@sinonjs/text\x2dencoding": {
                                TextEncoder: function () {
                                    throw new Error(
                                        "external text-encoding polyfill should not be required",
                                    );
                                },
                            },
                        });

                        xhr = new localSinonFakeXhr.FakeXMLHttpRequest();
                        xhr.responseType = "arraybuffer";
                        xhr.open("GET", "/");
                        xhr.send();
                        xhr.respond(200, {}, "hola");
                        ...
                        if (typeof originalTextEncoder === "undefined") {
                            delete global.TextEncoder;
                        } else {
                ...
                it("encodes surrogate-pair characters as utf-8 arraybuffers", function () {
                    this.xhr.responseType = "arraybuffer";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    assertArrayBufferMatches(
                        this.xhr.response,
                        new Uint8Array([0xf0, 0x9f, 0x98, 0x80]).buffer,
                    );
                });

                it("replaces malformed surrogate code units with utf-8 replacement bytes", function () {
                    this.xhr.responseType = "arraybuffer";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    assertArrayBufferMatches(
                        this.xhr.response,
                        new Uint8Array([0xef, 0xbf, 0xbd]).buffer,
                    );
                });
        ...
        if (supportsBlob) {
            describe("with Blob support", function () {
                ...
                it("defaults to empty Blob response", function () {
                    this.xhr.responseType = "blob";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    return assertBlobMatches(this.xhr.response, "");
                });

                it("returns blob with correct data", function () {
                    this.xhr.responseType = "blob";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    return assertBlobMatches(this.xhr.response, "a test blob");
                });

                it("returns blob with correct binary data", function () {
                    this.xhr.responseType = "blob";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    return assertBlobMatches(this.xhr.response, "\xFF");
                });

                it("returns blob with correct binary data when using an arraybuffer", function () {
                    this.xhr.responseType = "blob";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    return assertBlobMatches(
                        this.xhr.response,
                        new Blob([buffer]),
                    );
                });

                it("returns blob with correct binary data when using a blob", function () {
                    this.xhr.responseType = "blob";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    return assertBlobMatches(this.xhr.response, blob);
                });

                it("does parse utf-8 content outside ASCII range properly", function () {
                    this.xhr.responseType = "blob";
                    this.xhr.open("GET", "/");
                    this.xhr.send();
                    ...
                    return assertBlobMatches(this.xhr.response, responseText);
                });
            });
        }
    });
    ...
    describe("defaked XHR", function () {
        ...
        it("passes timeout to working XHR object on send", function () {
            var workingXHRInstance;
            var workingXHROverride = function () {
                workingXHRInstance = this;
                this.timeout = 0;
            ...
            runWithWorkingXHROveride(workingXHROverride, function () {
                FakeXMLHttpRequest.defake(fakeXhr, []);
                fakeXhr.timeout = 1234;
                fakeXhr.send();
                assert.equals(workingXHRInstance.timeout, 1234);
            });
        });
        ...
        it("does not set withCredentials on synchronous defaked XHR", function () {
            var spy;
            var workingXHROverride = function () {
                ...
                spy = sinonSpy(this, "withCredentials", ["set"]);
            };
        ...
        it("does not set timeout on synchronous defaked XHR", function () {
            var spy;
            var workingXHROverride = function () {
                this.open = function (method, url, async) {
                    this.async = async;
