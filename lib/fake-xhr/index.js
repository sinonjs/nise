...
/** @returns {Function|undefined} Blob constructor for the current global scope */
function getBlobConstructor() {
    return supportsBlob ? globalObject.Blob : undefined;
}

/** @returns {Function|undefined} FormData constructor for the current global scope */
        ...
        send: function send(data) {
            ...
            if (!/^(head)$/i.test(this.method)) {
                ...
                if (this.requestHeaders[contentType]) {
                    ...
                    !(FormDataConstructor && data instanceof FormDataConstructor)
                ) {
